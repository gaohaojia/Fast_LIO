...
def generate_launch_description():
    ...
    point_filter_num_param = LaunchConfiguration('point_filter_num', default='1')                 # int
    max_iteration_param = LaunchConfiguration('max_iteration', default='3')                       # int
    filter_size_surf_param = LaunchConfiguration('filter_size_surf', default='0.1')               # double
    filter_size_map_param = LaunchConfiguration('filter_size_map', default='0.1')                 # double
    ...
    default_config_path = os.path.join(package_path, 'config', 'unilidar.yaml')
